...
def main(pool):
    ...
    ax[0].set_xlabel('Winter Harvesting Rate, ' + r'$\mu_\omega$' + ' (year⁻¹)', fontsize=11); ax[0].set_ylabel('Autumn Harvesting Rate, ' + r'$\mu_\alpha$' + ' (year⁻¹)', fontsize=11)
    ...
    ax[1].set_xlabel('Winter Harvesting Rate, ' + r'$\mu_\omega$' + ' (year⁻¹)', fontsize=11); ax[1].set_ylabel('Autumn Harvesting Rate, ' + r'$\mu_\alpha$' + ' (year⁻¹)', fontsize=11)
